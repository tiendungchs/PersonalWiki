---
title: "ARC Prize 2026 Rules"
source: "https://www.kaggle.com/competitions/arc-prize-2026-arc-agi-3/rules"
author:
published:
created: 2026-07-02
...
**[See Section 3.18 for defined terms](https://www.kaggle.com/competitions/arc-prize-2026-arc-agi-3/rules#18.-terms)**
...
a. Submissions are required to have open source system, open source model, and open source weights/parameters, as defined in [the checklist](https://opensource.org/ai/checklist) from the [Open Source AI definition](https://opensource.org/ai/open-source-ai-definition) by the Open Source Initiative.

1. For generally commercially available software that you used to generate your Submission that is not owned by you, but that can be procured by the Competition Sponsor without undue expense, you do not need to grant the license in the preceding Section for that software.
2. In the event that input data or pretrained models with an incompatible license are used to generate your winning solution, you do not need to grant an open source license in the preceding Section for that data and/or model(s).
