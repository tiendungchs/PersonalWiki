...
2. All SOTA models score <2% single-run (o1-preview, GPT-4o, Claude 3.5 Sonnet, Gemini 1.5 Pro, Grok 2); o1-preview reaches ~6% at pass@8, matching the ARC-AGI-2 frontier capability gap scale (~4%) from a completely different domain.
