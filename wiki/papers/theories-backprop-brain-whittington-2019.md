...
- **[[wiki/concepts/predictive-coding.md]]** — PC (Predictive Coding) is the primary explicit-error model; theta oscillation phase-coordination for contrastive learning and the temporal-error context for the contrastive Hebbian precursor section added from this review.
- **[[wiki/concepts/hebbian-learning.md]]** — STDP form ↔ model class correspondence: asymmetric STDP = continuous update (temporal-error); symmetric STDP = PC (Predictive Coding) (explicit-error).
...
- **[[wiki/papers/whittington-bogacz-pc-backprop-2017.md]]** — predecessor paper by same authors; formal derivation of PC (Predictive Coding) ≈ backprop at energy minimum; this review extends the comparison to all four model classes.
