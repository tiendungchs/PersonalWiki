...
- **CA3 hippocampus as biological Hopfield network:** recurrent Schaffer collaterals + associative LTP enable pattern completion — full episodic memory recalled from a partial cue (Rolls 2013); grounds the engram co-retrieval mechanism in formal attractor dynamics.
