...
- **[[wiki/concepts/energy-based-models.md]]** — VICReg is the non-contrastive regularized EBM training method; the variance and covariance terms "shrink-wrap" the low-energy manifold around the data rather than pushing up energy on contrastive samples.
