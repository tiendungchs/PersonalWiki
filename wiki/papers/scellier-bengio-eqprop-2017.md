...
- [[wiki/entities/boltzmann-machine.md]] — CHL (Contrastive Hebbian Learning) vs. EqProp: full vs. weak output clamping; two-phase learning history
