...
- **Static/traveling-wave bifurcation at m = τ/τ_v:** SFA (Spike Frequency Adaptation) adaptation strength m above the threshold destabilizes the static bump into spontaneous propagation at analytic speed v_int = (2a/τ_v)√(mτ_v/τ − √(mτ_v/τ)); below threshold, the bump holds position as working memory.
