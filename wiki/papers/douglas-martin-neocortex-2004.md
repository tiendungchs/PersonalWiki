...
- The soft WTA model is qualitative; no formal derivation of selection dynamics or convergence criteria.

→ [[wiki/concepts/canonical-microcircuit.md]] — primary anatomy source for the canonical laminar circuit, recurrent amplification, soft WTA model, and SLN% hierarchy rule
→ [[wiki/concepts/predictive-coding.md]] — the laminar circuit is the anatomical substrate mapped to PC variables by Bastos et al. 2012, which cites this paper as primary anatomy source
...
→ [[wiki/papers/bastos-canonical-microcircuit-2012.md]] — directly builds on this paper: maps PC equations onto the circuit described here
