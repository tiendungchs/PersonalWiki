...
- **[[wiki/concepts/recursion.md]]** — MLC solves lexical productivity via episodic meta-learning but scores 100% error on SCAN-length (true recursive/discrete-infinity productivity), empirically bounding whether the recursive operator Hauser-Chomsky-Fitch call FLN can be meta-learned rather than architecturally supplied.
