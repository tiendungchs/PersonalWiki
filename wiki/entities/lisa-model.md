...
- **[[wiki/entities/prefrontal-cortex.md]]** — frontopolar BA-10 lesions selectively impair the ≥2 simultaneous relation integration that LISA's driver capacity implements; IFG handles the distractor suppression that LISA's semantic co-activation can otherwise induce.
