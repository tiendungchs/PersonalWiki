...
related: [wiki/concepts/latent-graph-discovery.md, wiki/concepts/factorized-representations.md, wiki/concepts/latent-states.md, wiki/concepts/path-integration.md, wiki/concepts/two-learning-timescales.md, wiki/concepts/neural-manifolds.md, wiki/concepts/compositional-generalization.md, wiki/concepts/successor-representation.md, wiki/concepts/temporal-context.md, wiki/concepts/abstract-reasoning.md, wiki/entities/tem-model.md, wiki/papers/tcm-mtl-howard-2005.md, wiki/entities/hippocampal-entorhinal-system.md, wiki/entities/grid-cells.md, wiki/entities/place-cells.md, wiki/entities/htm-thousand-brains.md, wiki/papers/gridlikecode-constantinescu-2016.md, wiki/papers/150000-mini-brain-transcript.md, wiki/papers/compositionality-decomposed-hupkes-2020.md, wiki/entities/mlc-model.md, wiki/papers/mlc-lake-baroni-2023.md, wiki/concepts/meta-learning.md, wiki/entities/arc-agi.md, wiki/papers/arc-agi-overview.md, wiki/papers/cls-mcclelland-1995.md, wiki/papers/building-machine-thinks-like-people-lake-2016.md, wiki/papers/pgm-barrett-2018.md, wiki/papers/conceptarc-moskvichev-2023.md, wiki/concepts/recursion.md, wiki/concepts/relational-reinterpretation.md, wiki/concepts/convergent-allocentric-coding.md, wiki/concepts/hierarchical-representations.md, wiki/entities/transformer-model.md]
---
...
## Primitive Precedent: The "Memory Space" (TCM)

The most stripped-down demonstration that latent structure can be *extracted* from co-occurrence predates TEM by 15 years. In the Temporal Context Model (Howard et al. 2005 [[wiki/papers/tcm-mtl-howard-2005.md]]), binding items to a drifting temporal context (α_N>0) makes the evoked representation `t_Aᴵᴺ` gradually absorb the contexts in which A appeared. Presenting a double-function chain `A→B→C→D→E→F` in random pair order yields:

$$t_B^{IN}\cdot t_D^{IN} > t_B^{IN}\cdot t_E^{IN} > t_B^{IN}\cdot t_F^{IN}$$

Representation similarity comes to encode **graph distance** — for pairs never presented together. Transitive inference then reduces to reading off a similarity gradient. This is structural generalization in its most primitive, fully analytic form: no factorized code, no periodic basis, just a leaky integrator plus Hebbian binding. It shows the *phenomenon* (latent-structure recovery) is separable from the *mechanism* (grid codes) — and marks exactly what TEM adds: a factorized, periodic code that makes the recovered structure **transferable to new content**, which TCM's content-bound similarity gradient cannot do.
...
- **[[wiki/concepts/temporal-context.md]]** — TCM's "memory space" is the most primitive instance of structural generalization: a leaky integrator plus Hebbian binding recovers latent graph distance from co-occurrence alone (transitive inference as a similarity gradient); it isolates what TEM adds — a factorized periodic code that makes recovered structure transferable to new content.
...
- **[[wiki/concepts/recursion.md]]** — Hauser-Chomsky-Fitch's domain-general-recursion hypothesis (recursion may have evolved for navigation/number, then became domain-general) is the evolutionary form of this page's central claim that grid/graph navigation machinery is reused for abstract relational reasoning; the Chomsky hierarchy grades how expressive the extracted structure W must be.
