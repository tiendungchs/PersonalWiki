...
related: [wiki/concepts/arbitrary-mapping.md, wiki/papers/murray-bussey-wise-pfc-arbitrary-mapping-2000.md, wiki/concepts/two-learning-timescales.md, wiki/concepts/neuromodulation.md, wiki/concepts/latent-states.md, wiki/concepts/structural-generalization.md, wiki/concepts/cognitive-control.md, wiki/concepts/abstract-reasoning.md, wiki/concepts/refinement-loops.md, wiki/entities/tem-model.md, wiki/entities/prefrontal-cortex.md, wiki/entities/basal-ganglia.md, wiki/queries/building-blocks-mec-hc-pfc.md, wiki/papers/pfc-meta-rl-wang-2018.md, wiki/papers/pbwm-oreilly-frank-2006.md, wiki/concepts/binding-problem.md, wiki/concepts/compositional-generalization.md, wiki/entities/mlc-model.md, wiki/papers/mlc-lake-baroni-2023.md, wiki/papers/pfc-cognitive-control-friedman-2021.md, wiki/papers/building-machine-thinks-like-people-lake-2016.md, wiki/papers/arc-agi-3-paper.md, wiki/papers/arc-prize-2025-technical-report.md, wiki/papers/gerfen-surmeier-dopamine-striatum-2011.md, wiki/papers/helie-ccn-bg-2013.md, wiki/papers/language-modeling-compression-deletang-2023.md, wiki/papers/hutter-aixi-2000.md, wiki/concepts/continual-learning.md, wiki/papers/hassabis-neuroscience-ai-2017.md, wiki/entities/covis-model.md, wiki/papers/meta-learning-plasticity-random-feedback.md, wiki/concepts/credit-assignment.md, wiki/entities/snn.md, wiki/papers/pcm-l2l-ortner-2025.md, wiki/papers/frontal-cortex-abstract-rules-badre2010.md, wiki/entities/spacetime-attractor.md, wiki/concepts/planning-as-inference.md, wiki/papers/mechanistic-planning-pfc-jensen-2026.md, wiki/queries/reasoning-as-coupled-navigation-strategizing.md, wiki/concepts/cultural-learning.md, wiki/concepts/neoteny.md, wiki/concepts/differentiable-plasticity.md, wiki/concepts/analogical-reasoning.md, wiki/concepts/probabilistic-language-of-thought.md, wiki/papers/daw-niv-dayan-uncertainty-arbitration-2005.md, wiki/concepts/successor-representation.md]
---
...
- **[[wiki/concepts/arbitrary-mapping.md]]** — supplies a *lesionable* biological inner-loop policy. The Repeat-Stay/Change-Shift strategy (repeat the response when the cue repeats; shift when it changes) is a learned plan over *trial structure*, not a cue→action mapping: it cuts initial 3-choice error 67%→33% before any binding exists. Its value here is the dissociation — PFv+o lesions abolish the strategy while hippocampectomy spares it even in monkeys who can no longer learn any new mapping (Murray, Bussey & Wise 2000) — which is direct evidence that the inner-loop policy is a *separate component* from the fast bindings it accelerates, rather than an emergent property of the same recurrent dynamics that hold them.
- **[[wiki/papers/murray-bussey-wise-pfc-arbitrary-mapping-2000.md]]** — source for the RS/CS strategy, its lesion dissociation, and the cortical-BG module architecture in which strategies and higher-order rules are held by the *same* parallel loops that hold specific mappings — a lesion-derived ancestor of MOSAIC's *N*-module organization.
...
- **[[wiki/papers/daw-niv-dayan-uncertainty-arbitration-2005.md]]** — the two accounts of model-based/model-free integration: Wang 2018 (sim 4) has a *single* meta-RL recurrent net produce MB two-step behavior emergent from MF training (arbitration internal to the dynamics), whereas Daw keeps MB tree-search and MF caching as *separate* controllers arbitrated per-decision by uncertainty; the reasoning model can use both — offline meta-RL consolidation plus an online uncertainty gate.
...
- **[[wiki/concepts/probabilistic-language-of-thought.md]]** — the symbolic instantiation of the slow/fast split: concept learning is a *program-generating meta-program* (slow) proposing hypotheses that `query` conditions on data (fast); the library evolves as learned concepts become primitives (changing inductive bias); PLoT's tractability wall is answered by amortized inference — a fast model-free net trained on the generative model's rollouts, the same fast/slow factorization this page describes.
