...
|---|---|---|---|
| **Attractor / persistent activity** | Recurrent excitation holds activity at fixed point during delay | Early single-unit recordings (Fuster 1971; Goldman-Rakic); bump attractor models of spatial WM | Majority of recorded PFC (Prefrontal Cortex) neurons show transient, not persistent, delay activity (Stokes 2013; Shafi 2007) |
