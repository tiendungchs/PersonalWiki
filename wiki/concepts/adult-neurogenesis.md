...
|---|---|---|---|
| **Gain-of-function** (promote newborn granule cell survival) | Rodent | Enhanced contextual discrimination; higher DG (Dentate Gyrus) orthogonalization | Newborn cells add separating capacity |
| **Loss-of-function** (x-irradiation ablation of DG (Dentate Gyrus) progenitors) | Rodent | Impaired spatial and contextual pattern separation; deficits in closely spaced object discrimination | Newborn cells are functionally necessary, not redundant |
...
2. **Net effect of integration + separation phases:** When a cohort of immature (integrating) and maturing (separating) cells coexist, the net DG (Dentate Gyrus) transfer function shifts; no model specifies how this is regulated across time.
...
- **[[wiki/concepts/pattern-separation.md]]** — adult neurogenesis is listed as mechanism 5 of the five DG (Dentate Gyrus) pattern separation mechanisms; this page provides the full evidence table and controversy that pattern-separation.md summarizes in one line.
