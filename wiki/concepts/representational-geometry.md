...
related: [wiki/concepts/abstract-reasoning.md, wiki/concepts/factorized-representations.md, wiki/concepts/latent-states.md, wiki/concepts/neural-manifolds.md, wiki/entities/hippocampal-entorhinal-system.md, wiki/entities/prefrontal-cortex.md, wiki/concepts/dendritic-computation.md, wiki/papers/pfc-categories-concepts-miller-2002.md, wiki/papers/geometry-abstraction-bernardi-2020.md, wiki/papers/raccah-pfc-consciousness-2021.md, wiki/papers/courellis-hpc-abstract-inference-2024.md, wiki/papers/nieh-hippocampal-geometry-2021.md, wiki/papers/chavlis-dann-2025.md, wiki/papers/lieberman-meyer-mpfc-subdivisions-2019.md]
---
...
- **[[wiki/papers/lieberman-meyer-mpfc-subdivisions-2019.md]]** — MVPA cross-classification gives two MPFC abstract-variable instances with the CCGP signature: the AMPFC **common-value scale** (train food-value → decode money-value) and the DMPFC **mental-state code** (train facial-expression → decode situation-inferred emotion); each is a coding direction invariant to surface stimulus class, the population geometry a stimulus-invariant value/latent-state read-out requires.
