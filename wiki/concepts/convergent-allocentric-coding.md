...
- **[[wiki/concepts/abstract-reasoning.md]]** — generalizes the which-substrate logic here to the full human trait *constellation* (MacLean 2016): spatial world-modeling is necessary but not sufficient; the motivational/social stack and the systemizing axis must also be chosen, and no single animal supplies all of it.
